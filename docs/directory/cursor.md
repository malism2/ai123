...
<div class="flex flex-col lg:flex-row gap-8 mt-4">
  <div class="flex-1">
    <h1 class="text-4xl font-bold text-slate-900 dark:text-white mb-4">Cursor</h1>
    <p class="text-lg text-slate-600 dark:text-slate-400 mb-6">The AI-first code editor.</p>
