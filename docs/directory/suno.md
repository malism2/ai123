...
<div style="display: flex; flex-direction: row; gap: 2rem; margin-top: 2rem; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 300px;">
    <h1 style="font-size: 2.5rem; font-weight: bold; margin-bottom: 1rem;">Suno AI</h1>
    <p style="font-size: 1.25rem; color: var(--vp-c-text-2); margin-bottom: 1.5rem;">Generate full songs with vocals and instruments.</p>
